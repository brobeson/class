...
\def\struckWeightChange
{
    \begin{align*}
        ...
        \|\Delta \vec{w}\|^2 &= \beta_r^{\vec{y}^2} \left[ \vec{\Phi} \left( \vec{x}_r, \vec{y}
        \right) \cdot \vec{\Phi} \left( \vec{x}_r, \vec{y} \right) + \vec{\Phi} \left( \vec{x}_r,
        \vec{y}_r \right) \cdot \vec{\Phi} \left( \vec{x}_r, \vec{y}_r \right) - 2 \vec{\Phi} \left(
        \vec{x}_r, \vec{y} \right) \cdot \vec{\Phi} \left( \vec{x}_r, \vec{y}_r \right) \right]
    \end{align*}
}
